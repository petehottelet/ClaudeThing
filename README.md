...
- Fresh telemetry requires USB or another local network path. With no path, the last validated snapshot remains visible and is labeled offline with its age.
